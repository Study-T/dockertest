...
func main() {
  ...
  "data": {
    ...
    "pod_url": "https://example.com/pod/yt2612500701966827.jpg",
    "IsSignature": true,
    "EstimatedDeliveryToDateZone": "2026-05-20",
    "EstimatedDeliveryFromDateZone": "2026-05-18",
    "track_events": [
      {
      ...
      {
        "process_time": "2026-05-15T09:30:00Z",
        "process_utc_time": "2026-05-15T09:30:00Z",
        "process_content": "派送中",
        "process_country": "DE",
        "process_province": "",
        "process_city": "柏林",
        "process_location": "柏林派送中心",
        "track_node_code": "DELIVERY_ATTEMPT",
        "track_node_description": "派送中",
        "pod_url": ""
      },
      {
        "process_time": "2026-05-15T14:20:00Z",
        "process_utc_time": "2026-05-15T14:20:00Z",
        "process_content": "已签收",
        "process_country": "DE",
        "process_province": "",
        "process_city": "柏林",
        "process_location": "柏林市中心",
	...
	fmt.Println("Updated data: added DELIVERY_ATTEMPT and DELIVERED events")
}
